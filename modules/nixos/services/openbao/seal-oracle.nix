{
  path = ["psyclyx" "nixos" "services" "openbao-seal-oracle"];
  ...
  config = {
    ...
    sealAttrs =
      builtins.removeAttrs cfg.seal
      (["type" "secretField"] ++ lib.optional hasSecret cfg.seal.secretField);
  ...
  in {
    ...
    environment.systemPackages =
      [pkgs.openbao]
      ++ lib.optionals cfg.tpm.enable [pkgs.tpm2-tools pkgs.tpm2-pkcs11];
