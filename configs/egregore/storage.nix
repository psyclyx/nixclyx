...
in
{
  ...
  config.entities = {
    ...
    # Tleilax's tank: 3x 2 TB SATA SSDs as raidz1 (~3.5 TiB usable).
    # General-purpose storage for the colo box — nvme image backups
    # today; future blockchain workloads, etc. live as sibling datasets.
