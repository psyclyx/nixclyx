...
#+begin_src emacs-lisp
  (general-define-key
   :prefix-map 'my/vc-find-prefix-map
  ...
  (general-define-key
   :prefix-map 'my/vc-create-prefix-map
  ...
  (general-define-key
   :prefix-map 'my/vc-prefix-map
   "c" (cons "create" my/vc-create-prefix-map)
   "f" (cons "find" my/vc-find-prefix-map)

   "R" (cons "Git revert file" #'vc-revert)
   "r" (cons "Git revert hunk" #'git-gutter:revert-hunk)
   "s" (cons "Git stage hunk" #'git-gutter:stage-hunk)
   "n" (cons "Jump to next hunk" #'git-gutter:next-hunk)
   "p" (cons "Jump to next hunk" #'git-gutter:previous-hunk)
...
#+begin_src emacs-lisp
  (general-define-key
   ...
   "v" (cons "versioning" my/vc-prefix-map)
